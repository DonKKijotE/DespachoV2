 ...
 */
final class Version20190430181429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE expedient DROP contrary, CHANGE comments comments VARCHAR(500) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE expedient ADD contrary VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE comments comments VARCHAR(500) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
