 ...
 */
final class Version20190504153531 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE expedient ADD code VARCHAR(100) NOT NULL, CHANGE comments comments VARCHAR(500) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE expedient DROP code, CHANGE comments comments VARCHAR(500) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
